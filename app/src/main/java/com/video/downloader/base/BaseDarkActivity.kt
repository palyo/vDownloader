...
abstract class BaseDarkActivity<B : ViewBinding>(
    ...
    fun initWindows() {
        ...
        WindowInsetsControllerCompat(window, window.decorView).apply {
            isAppearanceLightStatusBars = resources.getBoolean(R.bool.isLightMode)
            isAppearanceLightNavigationBars = resources.getBoolean(R.bool.isLightMode)
        }
    }
    ...
    fun applyStatusBar(color: Int) {
        window?.apply {
            statusBarColor = ContextCompat.getColor(this@BaseDarkActivity, color)
        }
    }
